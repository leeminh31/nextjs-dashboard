    ...
    <>
      <Row style={{ padding: "24px" }}>
        ...
        <Col span={24} style={{ padding: "15px" }}>
          ...
          <span style={{ marginLeft: "20px", color: "#b98868" }}>
        ...
        <Col span={24} style={{ padding: "15px" }}>
          <Button icon={<DownloadOutlined />}>Tải xuống</Button>
          <span style={{ marginLeft: "20px", color: "#b98868" }}>
            Báo cáo chấm công đếm số lần
          </span>
        </Col>
        <Col span={24} style={{ padding: "15px" }}>
          <Button icon={<DownloadOutlined />}>Tải xuống</Button>
          <span style={{ marginLeft: "20px", color: "#b98868" }}>
            Báo cáo đi muộn dưới 5 phút và trên 5 phút
          </span>
        </Col>
        <Col span={24} style={{ padding: "15px" }}>
          <Button icon={<DownloadOutlined />}>Tải xuống</Button>
          <span style={{ marginLeft: "20px", color: "#b98868" }}>
            Báo cáo ca đêm, ca gãy
          </span>
        </Col>
        <Col span={24} style={{ padding: "15px" }}>
          <Button icon={<DownloadOutlined />}>Tải xuống</Button>
